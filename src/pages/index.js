    ...
    <HomeLayout className="overflow-x-hidden">
      ...
      <section className="text-center">
        <div className="inline-block max-h-screen">
          ...
          <br />
          <h3 className="inline-block p-3 mb-4 text-xl font-semibold text-white rounded-md">
            {' '}
            Web Development, Music & everything between
          </h3>
        </div>
      ...
      <section
        id="Contact"
        className="flex flex-row justify-center mb-24 border-gray-200 featured body-font"
      >
        <div classNames="inline-block mx-auto text-center w-8 p-6 rounded-lg">
          ...
          <p className="pb-6 text-center ">
            ...
            <br /> Send an{' '}
            <a href="mailto:admin@goosebumps.co.zw">
          ...
          <p className="pb-6 text-center ">
            If you prefer to use a contact form,{' '}
            <Link
              to="/contact"
...
export const Query = graphql`
  {
    ...
    playlists: allMarkdownRemark(
      filter: { fileAbsolutePath: { regex: "/Playlists/" } }
    ) {
      edges {
        node {
          id
    ...
    mixes: allMarkdownRemark(
      filter: { fileAbsolutePath: { regex: "/Mixes/" } }
    ) {
      edges {
        node {
          id
