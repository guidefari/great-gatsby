        ...
        <div className="flex flex-col md:flex-row">
            <div className="flex flex-col justify-center max-w-md md:w-1/2">
                ...
                <div className="mt-4 text-xl text-left">
                    Built by: <a rel="noopener noreferrer" className=" link-transition about-link" href="https://twitter.com/txndai">Guide Fari</a>. That guy on the right, or the bottom🤷‍♂️<br></br><br></br>
                    Tech used: 
                    <ul>
