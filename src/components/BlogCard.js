    ...
    return (
        <div className='flex flex-col justify-between h-full'>
          <div className="h-full overflow-hidden rounded-lg shadow-lg ">
            <Img fluid={image} />
            <div className="flex flex-col justify-between p-6 bg-gray-600 min-h-sm lg:min-h-xs max-h-xs">
              <div>
                <h2 className="mb-1 text-xs font-medium tracking-widest title-font">{category}</h2>
                <h1 className="mb-3 text-xl font-semibold text-gray-800 lg:h-12 title-font">{title}</h1>
