...
const BlogCard = ({category, title, slug, path}) => {
    ...
    return (
        <div>
            <div className="h-full overflow-hidden border-2 rounded-lg border-gray-">
          ...
          <h2 className="mb-1 text-xs font-medium tracking-widest text-gray-500 title-font">{category}</h2>
            ...
            <div className="flex flex-wrap items-center ">
              <Link to={path} className="inline-flex items-center text-indigo-500 md:mb-2 lg:mb-0">Read full
